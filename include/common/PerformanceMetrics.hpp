...
struct RankCounters {
    ...
    std::uint64_t worker_activations_sent = 0;
    std::uint64_t worker_activations_received = 0;
    std::uint64_t order_batches_sent = 0;
    std::uint64_t order_batches_received_exchange = 0;
    std::uint64_t empty_order_batches = 0;
    std::uint64_t activation_bytes_sent_exchange = 0;
    std::uint64_t activation_bytes_received = 0;
    std::uint64_t shared_snapshot_publishes = 0;
    std::uint64_t shared_snapshot_reads = 0;
};
