...
#include <numeric>
#include <stdexcept>
BackgroundHawkesAgent::BackgroundHawkesAgent(const SimulationConfig& config) : mu_(config.hawkes_mu), alpha_(config.hawkes_alpha), beta_(std::max(1e-6, config.hawkes_beta)), rng_(config.seed + 911382323ULL) {}
