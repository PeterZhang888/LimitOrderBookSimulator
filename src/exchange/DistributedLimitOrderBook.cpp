...
void DistributedLimitOrderBook::seed_calibrated_book(
    int best_bid_ticks,
    int best_ask_ticks,
    int best_bid_depth,
    int best_ask_depth,
...
int DistributedLimitOrderBook::background_best_bid_depth() const {
...
int DistributedLimitOrderBook::background_best_ask_depth() const {
...
std::int64_t DistributedLimitOrderBook::total_bid_depth() const {
    return total_bid_quantity_;
}

std::int64_t DistributedLimitOrderBook::total_ask_depth() const {
    return total_ask_quantity_;
}

std::int64_t DistributedLimitOrderBook::total_background_bid_depth() const {
    return background_bid_quantity_;
}

std::int64_t DistributedLimitOrderBook::total_background_ask_depth() const {
...
ApplyResult DistributedLimitOrderBook::add_conserved_limit(
...
std::optional<int> DistributedLimitOrderBook::nearest_background_price(
    Side side) const {
...
DistributedLimitOrderBook::BackgroundWithdrawal
DistributedLimitOrderBook::withdraw_background_nearest(Side side,
                                                        int quantity) {
    if (quantity <= 0) return {};
...
int DistributedLimitOrderBook::cancel_at_distance(
    const OrderMessage& message,
    int* boundary_truncated_quantity) {
...
std::vector<TradeExecution> DistributedLimitOrderBook::take_trades() {
