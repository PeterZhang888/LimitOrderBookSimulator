...
An earlier diagnostic matrix is retained outside this chapter as a
superseded-mechanism audit.  Its paths were computationally complete, but the
dealer was already close to capacity, supplied little best-quote liquidity and
absorbed little of the shock.  Its nearly null contrasts are informative as a
mild natural-absorption experiment, but they do not identify an active
capacity-transmission mechanism and are not used as final causal estimates.
...
\input{docs/case-study/case_study_results.tex}
