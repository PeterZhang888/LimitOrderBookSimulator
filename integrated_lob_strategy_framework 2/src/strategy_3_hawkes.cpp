...
int main(int argc, char** argv) {
    const double theta = argc >= 2 ? std::atof(argv[1]) : 0.5;
    ...
    StrategyDayResult r = run_strategy_day(3, theta, day_id, replica_id, base_seed, false, "");
    std::cout << std::setprecision(12)
              << "strategy_id,day_id,replica_id,theta,pnl,inventory,avg_spread,total_volume,sharpe\n"
