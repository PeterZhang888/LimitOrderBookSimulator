...
int main(int argc, char** argv) {
    const double gamma = argc >= 2 ? std::atof(argv[1]) : 0.01;
    ...
    StrategyDayResult r = run_strategy_day(1, gamma, day_id, replica_id, base_seed, false, "");
    std::cout << std::setprecision(12)
              << "strategy_id,day_id,replica_id,gamma,pnl,inventory,avg_spread,total_volume,sharpe\n"
